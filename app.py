    ...
    <div id="questionnaire-screen" class="screen">
        <div class="container">
            ...
            <div class="card questionnaire-card" id="questionnaire-page-2" style="display:none;">
                ...
                <div class="question-item">
                    <p class="question-text">6. 如果让您选择参加一个答题项目，您最愿意选择哪种项目？</p>
                    <div class="categorical-options">
                        <label class="categorical-option"><input type="radio" name="q6" value="1"> 高波动、高回报的项目。</label>
                        <label class="categorical-option"><input type="radio" name="q6" value="2"> 略高波动、略高回报的项目。</label>
                        <label class="categorical-option"><input type="radio" name="q6" value="3"> 平均波动、平均回报的项目。</label>
                        <label class="categorical-option"><input type="radio" name="q6" value="4"> 略低波动、略低回报的项目。</label>
                        <label class="categorical-option"><input type="radio" name="q6" value="5"> 不愿意面对任何波动。</label>
                    </div>
                </div>
