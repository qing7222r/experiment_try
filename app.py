    ...
    <div id="instructions-p1" class="screen active">
        <div class="container">
            ...
            <div class="card instructions-card">
                ...
                <p>未作答的题目将不计分。</p>
                <p class="calc-hint">切出小程序没关系，可以用手机的计算器。</p>
    ...
    <div id="instructions-p2b" class="screen">
        <div class="container">
            ...
            <div class="card instructions-card">
                ...
                <p class="volatility-hint">注意：本轮 ε 有波动，结果不确定！</p>
...
<body>
    ...
    <script>
        ...
        function downloadCSV(sessions, filename) {
            const headers = ['被试编号', '分组', 'P1总数', 'P1答对', 'P1积分', 'P2a总数', 'P2a答对', 'P2a比较', 'P2b总数', 'P2b答对', 'ε', 'P2b调整积分', '比较结果', '时间'];
...
def phase2a_submit():
    ...
    db_exec(
        'UPDATE sessions SET phase2a_total = ?, phase2a_correct = ?, phase2a_adjusted = ?, phase2a_comparison = ? WHERE id = ?',
        (len(answers), correct, phase2a_adjusted, comparison, session.get('session_id'))
    )
