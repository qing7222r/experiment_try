    ...
    <div class="container">
        ...
        <div class="card">
            <div class="form-group">
                ...
                <input type="text" id="participant-id" placeholder="例如：P001（可随意填）" autofocus>
            </div>
        ...
        <div class="container">
            ...
            <div class="card result-card">
                ...
                <div class="question-item">
                    <p class="question-text" id="p2a-q1-text">1. 我认为我能获得高额奖金（5元），主要取决于我投入的努力。</p>
        ...
        <div class="container">
            ...
            <div class="card instructions-card">
                ...
                <div class="rule-box">
                    ...
                    <p><strong>第三阶段积分 = 第三阶段答对题数 × (1 + ε)</strong></p>
                    <p>其中 ε 是一个随机系数，<strong id="epsilon-range-p2b"></strong>内<strong>服从均匀分布</strong>。</p>
                    <p>如果 <strong>第三阶段积分 > 第一阶段积分</strong>，获得<strong class="text-high">高奖金 5元</strong>；</p>
                    <p>如果 <strong>第三阶段积分 < 第一阶段积分</strong>，获得<strong class="text-low">低奖金 1元</strong>。</p>
                </div>
                <p class="baseline-red-hint">现在你将看到第一阶段的成绩作为基线参考。</p>
    ...
    <div id="questionnaire-screen" class="screen">
        <div class="container">
            ...
            <div class="card questionnaire-card" id="questionnaire-page-1">
                <div class="question-item">
                    <p class="question-text" id="q1-text">1. 我认为我能获得高额奖金（5元），主要取决于我投入的努力。</p>
                    <div class="likert-scale">
